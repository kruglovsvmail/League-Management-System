    ...
    >
      ...
      {isVisible && createPortal(
        <div
          ...
          className="absolute z-[100010] bg-white/90 backdrop-blur-[10px] border border-graphite/10 shadow-[0_15px_35px_rgba(0,0,0,0.15)] rounded-xl p-3 flex items-start gap-3.5 pointer-events-none animate-fade-in-down transition-opacity duration-200"
