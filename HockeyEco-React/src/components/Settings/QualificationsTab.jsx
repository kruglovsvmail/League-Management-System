  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 items-start animate-fade-in-down">
      ...
      <div className="flex-1 w-full min-h-[400px] relative">
        {!canViewQuals ? (
          <div className="text-center py-20 text-status-rejected font-medium bg-white/30 backdrop-blur-md rounded-2xl shadow-[4px_0_24px_rgba(0,0,0,0.04)] border border-white/50">У вас нет прав для просмотра квалификаций</div>
        ) : (
          <>
            {isLoadingQuals && (
