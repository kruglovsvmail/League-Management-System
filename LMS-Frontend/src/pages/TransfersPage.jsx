                ...
                return (
                  <div key={tr.id} className={`grid transition-all duration-300 ease-in-out origin-top ${isHiding ? 'grid-rows-[0fr] opacity-0 mb-0 scale-[0.98]' : 'grid-rows-[1fr] opacity-100 mb-3 scale-100'}`}>
                    <div className="overflow-hidden">
                      <div className={`bg-white/70 backdrop-blur-[12px] border-[1px] border-white/40 rounded-lg overflow-hidden transition-all duration-100 ${isExpanded ? 'border-orange/20 shadow-mg' : 'hover:border-orange/50 shadow-mg'}`}>
