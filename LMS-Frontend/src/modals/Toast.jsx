...
export function Toast({ title, message, type = 'info', onClose }) {
  ...
  return (
    <div 
      ...
      className={`cursor-pointer fixed bottom-2 right-2 z-[100020] backdrop-blur-md text-graphite p-4 rounded-lg shadow-[0_10px_40px_rgba(0,0,0,0.08)] flex items-start gap-3.5 w-[300px] font-sans transition-opacity hover:opacity-90 ${current.bg} ${isHiding ? 'animate-slide-out' : 'animate-slide-in'}`}
    >
