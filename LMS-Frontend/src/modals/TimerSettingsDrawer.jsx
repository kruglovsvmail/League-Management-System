...
// предупреждения без файла прозвучит бип перед концом периода, если лига его задала.
              ...
              <div>
                ...
                <div className="bg-white border border-graphite/5 shadow-sm rounded-md">
                  ...
                  <div
                    ...
                    title="Голосом: за минуту до конца каждого периода и за две до конца последнего, голы и штрафы. Бип перед концом периода и удаления задаётся в настройках лиги — там же решается, звучит ли он при включённом голосе"
                  >
