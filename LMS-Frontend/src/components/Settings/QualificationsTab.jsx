            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col w-full mt-1">
                ...
                <textarea 
                  ...
                  className="w-full h-[120px] px-3 py-2.5 border border-graphite/40 rounded-md bg-white/30 text-graphite text-[13px] font-medium outline-none transition-all duration-300 focus:border-orange focus:bg-white resize-none" 
                />
              </div>
