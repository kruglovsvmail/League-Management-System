  ...
  return (
    ...
    >
      <div className="flex flex-col items-center w-full max-w-[1500px] relative overflow-hidden rounded-[70px] shadow-2xl transform-gpu">
        ...
        {/* ШАПКА */}
        <div className="flex justify-center items-center bg-black text-zinc-300 px-16 py-3 w-full relative z-10">
        ...
        <div className="flex w-full h-[600px] bg-zinc-950 overflow-hidden relative z-0">
          ...
          <div className="w-[60%] flex flex-col border-r-4 border-zinc-900 relative">
             ...
             <div className="flex-1 flex items-center justify-between px-12 relative border-b-2 border-zinc-900 overflow-hidden group bg-zinc-950">
                ...
                {homeLogo && (
                  <img src={homeLogo} alt="" className="absolute inset-0 w-full h-full object-cover opacity-30 blur-xl scale-[100%] z-0 pointer-events-none" />
                )}
             ...
             <div className="flex-1 flex items-center justify-between px-12 relative border-t-2 border-zinc-900 overflow-hidden group bg-zinc-950">
                {/* Крупный логотип на фоне (с сильным затемнением) */}
                {awayLogo && (
                  <img src={awayLogo} alt="" className="absolute inset-0 w-full h-full object-cover opacity-30 blur-xl scale-[100%] z-0 pointer-events-none" />
                )}
