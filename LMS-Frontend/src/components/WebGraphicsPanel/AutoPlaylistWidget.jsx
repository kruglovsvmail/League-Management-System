...
export function AutoPlaylistWidget({
  ...
  return (
    <>
      ...
      <div className="bg-white border-b border-graphite/10 w-full flex flex-col relative z-20 shrink-0">
        ...
        <div className={`grid transition-[grid-template-rows] duration-300 ease-in-out ${open ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
          <div className="overflow-hidden">
            <div className="flex items-stretch gap-6 px-4 pb-4 pt-3 border-t border-graphite/10">
