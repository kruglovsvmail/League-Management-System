...
export function SegmentButton({ options = ['Дни', 'Недели', 'Месяцы'], defaultIndex = 0, onChange, className = '' }) {
  ...
  return (
    <div className={`flex bg-graphite/10 rounded-md p-1 relative isolate ${className}`}>
        <div 
