  ...
  return (
    <div className="relative font-sans w-full" ref={containerRef}>
      ...
      {isOpen && !isDisabled && createPortal(
        <div 
          className="datepicker-portal absolute bg-white/95 backdrop-blur-xl rounded-xl border border-graphite/10 shadow-[0_15px_35px_rgba(0,0,0,0.15)] z-[100000] animate-zoom-in p-4 w-[260px]"
