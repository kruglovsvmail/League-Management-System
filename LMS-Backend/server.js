...
import setupBroadcastAnnouncer from './sockets/broadcastAnnouncer.js';
...
import penaltyTypeRoutes from './routes/penaltyTypeRoutes.js';
import registryRoutes from './routes/registryRoutes.js';
import teamManagementRoutes from './routes/teamManagementRoutes.js';
import clubManagementRoutes from './routes/clubManagementRoutes.js';
import communityManagementRoutes from './routes/communityManagementRoutes.js';
...
app.use('/api', penaltyTypeRoutes);
app.use('/api', registryRoutes);
app.use('/api', teamManagementRoutes);
app.use('/api', clubManagementRoutes);
app.use('/api', communityManagementRoutes);
