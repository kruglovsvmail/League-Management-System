...
export const TEAM_SNAPSHOT_FIELDS = [
    ...
    { key: 'color_home',    app: ['snap_color_home_1', 'snap_color_home_2'], team: ['color_home_1', 'color_home_2'], label: 'Домашние цвета', kind: 'color' },
    { key: 'color_away',    app: ['snap_color_away_1', 'snap_color_away_2'], team: ['color_away_1', 'color_away_2'], label: 'Гостевые цвета', kind: 'color' },
    { key: 'jersey_dark',   app: 'custom_jersey_dark_url',  team: 'jersey_dark_url',  label: 'Домашняя форма',  kind: 'image' },
    { key: 'jersey_light',  app: 'custom_jersey_light_url', team: 'jersey_light_url', label: 'Гостевая форма',  kind: 'image' },
